...
#SBATCH --job-name=cosmos-h-case123-seg
#SBATCH --output=inference_output/case123_seg_%j.out
#SBATCH --error=inference_output/case123_seg_%j.err
...
PYTHON_CMD="python examples/inference.py -i assets/case123_seg/seg/case123_seg_spec.json -o outputs/case123_seg"
...
date
echo "Inference complete. Check outputs/case123_seg for results."
